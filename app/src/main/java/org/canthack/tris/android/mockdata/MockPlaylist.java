...
public class MockPlaylist {
    public static ArrayList<HgdSong> getPlaylist() {
      ...
      //  list.add(new HgdSong().setArtistName("Miigy Mouse").setAlbumName("Noo I gooo").setTrackName("Yarp").setUserName("miig").autoSetAlbumArtUrl());
        ...
        list.add(new HgdSong().setArtistName("KoRn").setAlbumName("Follow the Leader").setTrackName("Freak on a Leash").setUserName("tim").autoSetAlbumArtUrl());
        list.add(new HgdSong().setArtistName("Metallica").setAlbumName("Metallica").setTrackName("Enter Sandman").setUserName("aaron").autoSetAlbumArtUrl());
        list.add(new HgdSong().setArtistName("Billy Childish").setAlbumName("Thatcher's Children").setTrackName("Thatcher's Children").setUserName("tim").autoSetAlbumArtUrl());
